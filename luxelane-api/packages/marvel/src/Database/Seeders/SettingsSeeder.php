    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
            'options' => json_encode([
                ...
                "siteLink" =>  "https://luxelane.redq.io/",
    ...
    private function maintenanceSettings(): array
    {
        return [
            ...
            "maintenance" => [
                ...
                "aboutUsDescription"    => "Welcome to luxelane, your go-to destination for curated excellence. Discover a fusion of style, quality, and affordability in every click. Join our community and elevate your shopping experience with us!",
                "image" => [
                    'id'        => 346,
    ...
    private function promoPopupSettings(): array
    {
        return [
            ...
            "promoPopup" => [
                "image" => [
                    "id" => 327,
                    "original" => "https://chawkbazarlaravel.s3.ap-southeast-1.amazonaws.com/327/luxelane-img.png",
                    "file_name" => "luxelane-img.png",
                    "thumbnail" => "https://chawkbazarlaravel.s3.ap-southeast-1.amazonaws.com/327/conversions/luxelane-img-thumbnail.jpg"
                ],
