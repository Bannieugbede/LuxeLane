...
await $`ssh -o StrictHostKeyChecking=no -l ${username} ${ip_address} "rm -rf /var/www/luxelane-laravel/shop.zip /var/www/luxelane-laravel/shop";`
...
await $`ssh -o StrictHostKeyChecking=no -l ${username} ${ip_address} "unzip /var/www/luxelane-laravel/shop.zip -d /var/www/luxelane-laravel";`

echo('Install Node For shop')
await $`ssh -o StrictHostKeyChecking=no -l ${username} ${ip_address} "yarn --cwd /var/www/luxelane-laravel/shop";`
